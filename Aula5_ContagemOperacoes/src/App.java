...
public class App {
    ...
    // Ordena um vetor de inteiros em ordem crescente, encontrando o menor elemento da parte não ordenada e colocando-o no início
    ...
    public static void main(String[] args) {
        ...
        for (int tamanho : tamanhosTesteGrande) {
            ...
            System.out.println("Código 1 - Tamanho: " + tamanho + ", Resultado: " + resultado1 + ", Tempo: " + tempo1 + " ns");
        }
        ...
        for (int tamanho : tamanhosTesteGrande) {
            ...
            System.out.println("Código 2 - Tamanho: " + tamanho + ", Resultado: " + resultado2 + ", Tempo: " + tempo2 + " ns");
        }
        ...
        for (int tamanho : tamanhosTesteMedio) {
            ...
            System.out.println("Código 3 - Tamanho: " + tamanho + ", Trocas: " + trocas + ", Tempo: " + tempo + " ns");
        }
        ...
        for (int n : tamanhosTestePequeno) {
            ...
            long tempo = System.nanoTime() - inicio;
            System.out.println("Código 4 - n: " + n + ", Resultado: " + resultado + ", Tempo: " + tempo + " ns");
        }
    }
}